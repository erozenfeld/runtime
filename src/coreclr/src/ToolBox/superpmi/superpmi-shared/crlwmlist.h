...
DENSELWM(RecordCallee, CompileResult::Agnostic_RecordCallee)
DENSELWM(RecordMethodPointer, CompileResult::Agnostic_RecordMethodPointer)
DENSELWM(RecordUnusedParameters, DWORD)
